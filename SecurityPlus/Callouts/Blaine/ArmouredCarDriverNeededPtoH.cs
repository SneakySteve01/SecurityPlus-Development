...
{
    [CalloutInfo("ArmouredCarDriverNeededPtoH", CalloutProbability.High)]
    
    public class ArmouredCarDriverNeededPtoH : Callout
    {
        ...
        {
            Log.log("Starting Callout - ArmouredCarDriverNeededPtoH");
            
            ambusher1Location = new Vector3(2554.625f, 3070.484f, 44.17746f);
            ambusher2Location = new Vector3(2471.022f, 5529.177f, 44.26823f);
            ambusher3Location = new Vector3(-56.20996f, 6453.607f, 30.78031f);
            
            endPos = new Vector3(1175.519f, 2696.043f, 37.78687f);
            calloutPosition = new Vector3(-121.4141f, 6479.96f, 30.7183f);
        ...
        public override void Process()
        {
            ...
            if (!driveStarted)
            {
                ...
                {
                    Game.DisplayNotification("Dispatch: Attention " + Main.UID + ", the money in this van is to be taken to Fleeca Bank 68 in Harmony. Be advised that the details of your route may have been compromised, remain vigilant.");
                    driveStarted = true;
            ...
            if (driveStarted)
            {
                switch (option)
                {
                    ...
                    case 1:
                    {
                        ...
                        {
                            ambusherCar2 = new Vehicle("sentinel", ambusher2Location, 241.4009f);
                            ambusher2 = new Ped(ambusher2Location, 241.4009f);
                    ...
                    case 2:
                    {
                        ...
                        {
                            ambusherCar3 = new Vehicle("dominator", ambusher3Location, 180.4972f);
                            ambusher3 = new Ped(ambusher3Location, 180.4972f);
                            ambusher3.Inventory.GiveNewWeapon(WeaponHash.PumpShotgun, -1, true);
                            ambusher3.WarpIntoVehicle(ambusherCar3, -1);
                            a3Spawned = true;

                            ambusher4 = new Ped(ambusher3Location, 180.4972f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ ArmouredCarDriverNeededPtoH callout has been cleaned up");
            Game.LogTrivial("Security+ ArmouredCarDriverNeededPtoH callout has been cleaned up");
        }
    }
}