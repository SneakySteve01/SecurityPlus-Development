...
{
    [CalloutInfo("OpenCarryYouTool", CalloutProbability.High)]
    
    public class OpenCarryYouTool : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryYouTool");
            
            calloutPosition = new Vector3(2748.306f, 3466.582f, 55.69942f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 205.6644f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryYouTool callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryYouTool callout has been cleaned up");
        }
    }
}