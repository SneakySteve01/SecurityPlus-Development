...
{
    [CalloutInfo("CasingYouTool", CalloutProbability.High)]
    
    public class CasingYouTool : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingYouTool");
            
            calloutPosition = new Vector3(2755.43f, 3478.972f, 55.64808f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 119.8754f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(2757.232f, 3477.5f, 55.63756f), 108.0843f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingYouTool callout has been cleaned up");
            Game.LogTrivial("Security+ CasingYouTool callout has been cleaned up");
        }
    }
}