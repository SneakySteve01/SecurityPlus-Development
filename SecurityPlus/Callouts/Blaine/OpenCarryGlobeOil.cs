...
{
    [CalloutInfo("OpenCarryGlobeOil", CalloutProbability.High)]
    
    public class OpenCarryGlobeOil : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryGlobeOil");
            
            calloutPosition = new Vector3(1724.844f, 6411.899f, 35.00835f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 238.8282f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryGlobeOil callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryGlobeOil callout has been cleaned up");
        }
    }
}