...
{
    [CalloutInfo("OpenCarryLoggerBar", CalloutProbability.High)]
    
    public class OpenCarryLoggerBar : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLoggerBar");
            
            calloutPosition = new Vector3(-756.1839f, 5570.528f, 36.70965f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 65.22266f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLoggerBar callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLoggerBar callout has been cleaned up");
        }
    }
}