...
{
    [CalloutInfo("RefusingToPayLoggerBar", CalloutProbability.High)]
    
    public class RefusingToPayLoggerBar : Callout
    {
        ...
        {
            Log.log("Starting Callout - RefusingToPayLoggerBar");
            
            calloutPosition = new Vector3(-769.6057f, 5583.654f, 33.48571f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            owner = new Ped("s_m_y_waiter_01", calloutPosition, 212.6916f);
            
            suspect = new Ped(new Vector3(-767.6732f, 5579.922f, 33.60593f), 338.9626f);

            suspect.Inventory.GiveNewWeapon(WeaponHash.CombatPistol, -1, false);

            susCar = new Vehicle("BALLER", new Vector3(-772.4685f, 5575.355f, 33.46404f), 88.8158f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ RefusingToPayLoggerBar callout has been cleaned up");
            Game.LogTrivial("Security+ RefusingToPayLoggerBar callout has been cleaned up");
        }
    }
}