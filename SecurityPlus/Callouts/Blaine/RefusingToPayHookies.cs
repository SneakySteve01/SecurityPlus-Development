...
{
    [CalloutInfo("RefusingToPayHookies", CalloutProbability.High)]
    
    public class RefusingToPayHookies : Callout
    {
        ...
        {
            Log.log("Starting Callout - RefusingToPayHookies");
            
            calloutPosition = new Vector3(-2192.794f, 4283.568f, 49.17596f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            owner = new Ped("s_m_y_waiter_01", calloutPosition, 159.7755f);
            
            suspect = new Ped(new Vector3(-2194.16f, 4279.462f, 49.17622f), 339.3351f);

            suspect.Inventory.GiveNewWeapon(WeaponHash.CombatPistol, -1, false);

            susCar = new Vehicle("BALLER", new Vector3(-2196.976f, 4269.571f, 48.49287f), 148.2562f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ RefusingToPayHookies callout has been cleaned up");
            Game.LogTrivial("Security+ RefusingToPayHookies callout has been cleaned up");
        }
    }
}