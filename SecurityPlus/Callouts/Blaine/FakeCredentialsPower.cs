...
{
    [CalloutInfo("FakeCredentialsPower", CalloutProbability.High)]
    
    public class FakeCredentialsPower : Callout
    {
        ...
        {
            Log.log("Starting Callout - FakeCredentialsPower");
            
            calloutPosition = new Vector3(2659.321f, 1638.009f, 24.25973f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 269.3867f);
            susCar = new Vehicle(cars[new Random().Next(cars.Length)], calloutPosition, 269.3867f);

            suspect.WarpIntoVehicle(susCar, -1);
            
            gatePed = new Ped("IG_TRAFFICWARDEN", new Vector3(2662.722f, 1639.589f, 24.59124f), 90.71797f);
                ...
                case 0:
                {
                    ...
                    if (optionTime)
                    {
                        if (Game.IsKeyDown(Keys.I) && !iPressed)
                        {
                            ...
                            noose = new Ped("s_m_m_highsec_01", new Vector3(2531.929f, 1638.579f, 28.81462f), 269.9014f);
                            noose2 = new Ped("s_m_m_highsec_02", new Vector3(2531.929f, 1638.579f, 28.81462f), 269.9014f);
                            nooseCar = new Vehicle(Main.fbiCar, new Vector3(2531.929f, 1638.579f, 28.81462f), 269.9014f);
                            ...
                            noose.Tasks.DriveToPosition(nooseCar, new Vector3(2654.84f, 1646.285f, 24.29321f), 10f, VehicleDrivingFlags.Emergency, 1f).WaitForCompletion();
                            ...
                            if (suspect.IsCuffed)
                            {
                                ...
                                noose.Tasks.DriveToPosition(nooseCar, new Vector3(2830.373f, 1627.513f, 24.2421f), 15f, VehicleDrivingFlags.Emergency, 2f).WaitForCompletion(15000);
                                Game.DisplayNotification("Security Dispatcher: Attention " + Main.UID + ", call is code 4.");
                                End();
                                if (noose.DistanceTo(new Vector3(2830.373f, 1627.513f, 24.2421f)) < 5f || noose2.DistanceTo(new Vector3(2830.373f, 1627.513f, 24.2421f)) < 5f || suspect.DistanceTo(new Vector3(2830.373f, 1627.513f, 24.2421f)) < 5f || nooseCar.DistanceTo(new Vector3(2830.373f, 1627.513f, 24.2421f)) < 5f)
                                {
                                    Game.DisplayNotification("Security Dispatcher: Attention " + Main.UID + ", call is code 4.");
                                    End();
                                }
        ...
        public override void End()
        {
            ...
            Log.log("Security+ FakeCredentialsPower callout has been cleaned up");
            Game.LogTrivial("Security+ FakeCredentialsPower callout has been cleaned up");
        }
    }
}