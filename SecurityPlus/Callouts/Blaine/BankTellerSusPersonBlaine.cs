...
{
    [CalloutInfo("BankTellerSusPersonBlaine", CalloutProbability.High)]
    
    public class BankTellerSusPersonBlaine : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonBlaine");
            
            calloutPosition = new Vector3(-111.6101f, 6457.757f, 31.46736f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 350.0749f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonBlaine callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonBlaine callout has been cleaned up");
        }
    }
}