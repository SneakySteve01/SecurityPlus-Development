...
{
    [CalloutInfo("CasingDavisMegaMall", CalloutProbability.High)]
    
    public class CasingDavisMegaMall : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingDavisMegaMall");
            
            calloutPosition = new Vector3( 35.18025f, -1754.23f, 29.30291f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 290.2887f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(35.63105f, -1752.343f, 29.3032f), 291.063f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingDavisMegaMall callout has been cleaned up");
            Game.LogTrivial("Security+ CasingDavisMegaMall callout has been cleaned up");
        }
    }
}