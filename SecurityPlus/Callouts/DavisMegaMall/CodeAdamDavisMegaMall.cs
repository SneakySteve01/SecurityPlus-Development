...
namespace SecurityPlus.Callouts.DavisMegaMall
{
    [CalloutInfo("CodeAdamDavisMegaMall", CalloutProbability.High)]
    
    public class CodeAdamDavisMegaMall : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamDavisMegaMall");
            
            calloutPosition = new Vector3(37.02222f, -1734.439f, 29.0413f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 47.81293f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 47.81293f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamDavisMegaMall callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamDavisMegaMall callout has been cleaned up");
        }
    }
}