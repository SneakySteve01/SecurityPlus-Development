...
{
    [CalloutInfo("RefusingToPayPaleto", CalloutProbability.High)]
    
    public class RefusingToPayPaleto : Callout
    {
        ...
        {
            Log.log("Starting Callout - RefusingToPayPaleto");
            
            calloutPosition = new Vector3(-311.5293f, 6256.496f, 31.50512f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            owner = new Ped("s_m_y_waiter_01", calloutPosition, 45.66423f);
            
            suspect = new Ped(new Vector3(-314.257f, 6259.209f, 31.49854f), 219.3558f);

            suspect.Inventory.GiveNewWeapon(WeaponHash.CombatPistol, -1, false);

            susCar = new Vehicle("BALLER", new Vector3(-323.2827f, 6262.744f, 31.37459f), 135.1365f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ RefusingToPayPaleto callout has been cleaned up");
            Game.LogTrivial("Security+ RefusingToPayPaleto callout has been cleaned up");
        }
    }
}