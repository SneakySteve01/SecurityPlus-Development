...
{
    [CalloutInfo("CodeAdamPaleto2", CalloutProbability.High)]
    
    public class CodeAdamPaleto2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamPaleto2");
            
            calloutPosition = new Vector3(-88.15267f, 6547.232f, 31.22927f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 225.3691f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 225.3691f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamPaleto2 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamPaleto2 callout has been cleaned up");
        }
    }
}