...
{
    [CalloutInfo("OpenCarryPaleto4", CalloutProbability.High)]
    
    public class OpenCarryPaleto4 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryPaleto4");
            
            calloutPosition = new Vector3(-400.4386f, 6057.772f, 31.50011f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 182.4955f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryPaleto4 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryPaleto4 callout has been cleaned up");
        }
    }
}