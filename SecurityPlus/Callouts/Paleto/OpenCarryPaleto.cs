...
{
    [CalloutInfo("OpenCarryPaleto", CalloutProbability.High)]
    
    public class OpenCarryPaleto : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryPaleto");
            
            calloutPosition = new Vector3(168.1307f, 6631.353f, 31.56468f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 168.0997f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryPaleto callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryPaleto callout has been cleaned up");
        }
    }
}