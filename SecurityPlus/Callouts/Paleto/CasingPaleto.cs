...
{
    [CalloutInfo("CasingPaleto", CalloutProbability.High)]
    
    public class CasingPaleto : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingPaleto");
            
            calloutPosition = new Vector3(168.769f, 6625.758f, 31.78201f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 31.81381f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(168.5655f, 6627.336f, 31.77314f), 31.94016f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingPaleto callout has been cleaned up");
            Game.LogTrivial("Security+ CasingPaleto callout has been cleaned up");
        }
    }
}