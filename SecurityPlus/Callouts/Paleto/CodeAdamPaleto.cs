...
{
    [CalloutInfo("CodeAdamPaleto", CalloutProbability.High)]
    
    public class CodeAdamPaleto : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamPaleto");
            
            calloutPosition = new Vector3(135.3037f, 6652.176f, 31.35729f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamPaleto callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamPaleto callout has been cleaned up");
        }
    }
}