...
{
    [CalloutInfo("LoiterPaleto2", CalloutProbability.High)]
    
    public class LoiterPaleto2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterPaleto2");
            
            calloutPosition = new Vector3(-98.22367f, 6405.707f, 31.64036f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 42.27803f);
            suspect2 = new Ped(new Vector3(-97.73795f, 6407.619f, 31.4706f), 136.4615f);
            suspect3 = new Ped(new Vector3(-101.0241f, 6406.145f, 31.48523f), 262.2495f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterPaleto2 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterPaleto2 callout has been cleaned up");
        }
    }
}