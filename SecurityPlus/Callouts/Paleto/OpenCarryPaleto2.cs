...
{
    [CalloutInfo("OpenCarryPaleto2", CalloutProbability.High)]
    
    public class OpenCarryPaleto2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryPaleto2");
            
            calloutPosition = new Vector3(-70.5105f, 6535.903f, 31.49082f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 299.7563f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryPaleto2 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryPaleto2 callout has been cleaned up");
        }
    }
}