...
{
    [CalloutInfo("LoiterLS4", CalloutProbability.High)]
    
    public class LoiterLS4 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS4");
            
            calloutPosition = new Vector3(-707.6823f, -917.2094f, 19.21432f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 176.306f);
            suspect2 = new Ped(new Vector3(-706.3635f, -917.2937f, 19.21431f), 140.5392f);
            suspect3 = new Ped(new Vector3(-707.5389f, -919.093f, 19.01392f), 343.1899f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS4 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS4 callout has been cleaned up");
        }
    }
}