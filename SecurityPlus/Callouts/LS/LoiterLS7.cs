...
{
    [CalloutInfo("LoiterLS7", CalloutProbability.High)]
    
    public class LoiterLS7 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS7");
            
            calloutPosition = new Vector3(1167.227f, -324.1565f, 69.25636f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 282.7304f);
            suspect2 = new Ped(new Vector3(1167.889f, -322.1765f, 69.29431f), 165.5199f);
            suspect3 = new Ped(new Vector3(1169.315f, -325.0865f, 69.31443f), 43.61842f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS7 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS7 callout has been cleaned up");
        }
    }
}