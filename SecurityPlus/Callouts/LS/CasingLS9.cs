...
{
    [CalloutInfo("CasingLS9", CalloutProbability.High)]
    
    public class CasingLS9 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS9");
            
            calloutPosition = new Vector3(233.477f, -1795.497f, 28.17613f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 49.07353f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(232.4448f, -1793.896f, 28.27868f), 74.56845f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS9 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS9 callout has been cleaned up");
        }
    }
}