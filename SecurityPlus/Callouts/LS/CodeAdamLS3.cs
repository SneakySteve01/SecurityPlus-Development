...
{
    [CalloutInfo("CodeAdamLS3", CalloutProbability.High)]
    
    public class CodeAdamLS3 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS3");
            
            calloutPosition = new Vector3(-730.5101f, -910.1005f, 18.7794f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 177.2283f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 177.2283f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS3 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS3 callout has been cleaned up");
        }
    }
}