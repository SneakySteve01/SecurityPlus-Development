...
{
    [CalloutInfo("OpenCarryLS6", CalloutProbability.High)]
    
    public class OpenCarryLS6 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS6");
            
            calloutPosition = new Vector3(647.0933f, 268.5421f, 103.2607f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 68.36462f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS6 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS6 callout has been cleaned up");
        }
    }
}