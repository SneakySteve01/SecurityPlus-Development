...
{
    [CalloutInfo("CodeAdamLS7", CalloutProbability.High)]
    
    public class CodeAdamLS7 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS7");
            
            calloutPosition = new Vector3(1200.984f, -1396.008f, 34.9656f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 179.07f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 179.07f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS7 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS7 callout has been cleaned up");
        }
    }
}