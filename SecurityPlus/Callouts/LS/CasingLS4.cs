...
{
    [CalloutInfo("CasingLS4", CalloutProbability.High)]
    
    public class CasingLS4 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS4");
            
            calloutPosition = new Vector3(-717.9261f, -909.3094f, 19.21559f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 247.8975f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(-717.2124f, -910.9405f, 19.21559f), 171.9317f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS4 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS4 callout has been cleaned up");
        }
    }
}