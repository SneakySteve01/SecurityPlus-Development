...
{
    [CalloutInfo("LoiterLS", CalloutProbability.High)]
    
    public class LoiterLS : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS");
            
            calloutPosition = new Vector3(-572.9966f, -1014.853f, 22.32425f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 270.4489f);
            suspect2 = new Ped(new Vector3(-572.1323f, -1016.172f, 22.32425f), 34.48997f);
            suspect3 = new Ped(new Vector3(-571.8432f, -1012.621f, 22.32425f), 152.6938f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS callout has been cleaned up");
        }
    }
}