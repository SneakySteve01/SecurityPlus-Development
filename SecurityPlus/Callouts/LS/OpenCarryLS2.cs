...
{
    [CalloutInfo("OpenCarryLS2", CalloutProbability.High)]
    
    public class OpenCarryLS2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS2");
            
            calloutPosition = new Vector3(202.5335f, -24.87646f, 69.9062f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 236.4477f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS2 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS2 callout has been cleaned up");
        }
    }
}