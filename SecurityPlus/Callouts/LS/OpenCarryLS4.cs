...
{
    [CalloutInfo("OpenCarryLS4", CalloutProbability.High)]
    
    public class OpenCarryLS4 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS4");
            
            calloutPosition = new Vector3(-717.6055f, -910.4213f, 19.21559f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 221.3312f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS4 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS4 callout has been cleaned up");
        }
    }
}