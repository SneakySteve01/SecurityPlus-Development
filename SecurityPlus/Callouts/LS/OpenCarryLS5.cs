...
{
    [CalloutInfo("OpenCarryLS5", CalloutProbability.High)]
    
    public class OpenCarryLS5 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS5");
            
            calloutPosition = new Vector3(-40.31915f, -215.6249f, 45.80079f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 154.3005f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS5 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS5 callout has been cleaned up");
        }
    }
}