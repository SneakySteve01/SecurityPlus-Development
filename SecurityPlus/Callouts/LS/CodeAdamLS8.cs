...
{
    [CalloutInfo("CodeAdamLS8", CalloutProbability.High)]
    
    public class CodeAdamLS8 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS8");
            
            calloutPosition = new Vector3(233.2921f, -1791.252f, 28.16309f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 145.7819f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 145.7819f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS8 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS8 callout has been cleaned up");
        }
    }
}