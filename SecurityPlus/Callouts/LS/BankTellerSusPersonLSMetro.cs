...
{
    [CalloutInfo("BankTellerSusPersonLSMetro", CalloutProbability.High)]
    
    public class BankTellerSusPersonLSMetro : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonLSMetro");
            
            calloutPosition = new Vector3(-811.4252f, -1113.527f, 11.17471f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 107.4278f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonLSMetro callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonLSMetro callout has been cleaned up");
        }
    }
}