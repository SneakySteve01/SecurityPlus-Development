...
{
    [CalloutInfo("CasingLS6", CalloutProbability.High)]
    
    public class CasingLS6 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS6");
            
            calloutPosition = new Vector3(650.1316f, 277.6138f, 103.296f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 158.5047f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(649.8682f, 274.0387f, 103.295f), 144.6653f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS6 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS6 callout has been cleaned up");
        }
    }
}