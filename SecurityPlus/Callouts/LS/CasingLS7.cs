...
{
    [CalloutInfo("CasingLS7", CalloutProbability.High)]
    
    public class CasingLS7 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS7");
            
            calloutPosition = new Vector3(1152.637f, -320.3161f, 69.20508f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 259.7989f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(1153.232f, -322.1412f, 69.20508f), 178.3692f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS7 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS7 callout has been cleaned up");
        }
    }
}