...
{
    [CalloutInfo("CodeAdamLS4", CalloutProbability.High)]
    
    public class CodeAdamLS4 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS4");
            
            calloutPosition = new Vector3(-52.3047f, -218.5138f, 45.184f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 159.3123f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 159.3123f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS4 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS4 callout has been cleaned up");
        }
    }
}