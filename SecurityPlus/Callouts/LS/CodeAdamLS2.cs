...
{
    [CalloutInfo("CodeAdamLS2", CalloutProbability.High)]
    
    public class CodeAdamLS2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS2");
            
            calloutPosition = new Vector3(-819.8265f, -1091.629f, 10.723f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 302.1407f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 302.1407f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS2 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS2 callout has been cleaned up");
        }
    }
}