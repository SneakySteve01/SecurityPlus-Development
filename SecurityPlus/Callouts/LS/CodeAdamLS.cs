...
{
    [CalloutInfo("CodeAdamLS", CalloutProbability.High)]
    
    public class CodeAdamLS : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS");
            
            calloutPosition = new Vector3(-576.5469f, -999.04f, 21.91636f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 270.386f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 270.386f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS callout has been cleaned up");
        }
    }
}