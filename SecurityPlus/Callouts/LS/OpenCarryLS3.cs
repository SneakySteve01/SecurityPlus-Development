...
{
    [CalloutInfo("OpenCarryLS3", CalloutProbability.High)]
    
    public class OpenCarryLS3 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS3");
            
            calloutPosition = new Vector3(-819.0661f, -1080.069f, 11.1325f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 213.6953f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS3 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS3 callout has been cleaned up");
        }
    }
}