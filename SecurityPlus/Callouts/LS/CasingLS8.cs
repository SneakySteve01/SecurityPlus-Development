...
{
    [CalloutInfo("CasingLS8", CalloutProbability.High)]
    
    public class CasingLS8 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS8");
            
            calloutPosition = new Vector3(1204.882f, -1389.891f, 35.22696f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 271.0862f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(1205.375f, -1390.957f, 35.22696f), 284.7397f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS8 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS8 callout has been cleaned up");
        }
    }
}