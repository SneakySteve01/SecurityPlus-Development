...
{
    [CalloutInfo("OpenCarryLS7", CalloutProbability.High)]
    
    public class OpenCarryLS7 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS7");
            
            calloutPosition = new Vector3(1154.132f, -326.563f, 69.20506f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 305.3838f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS7 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS7 callout has been cleaned up");
        }
    }
}