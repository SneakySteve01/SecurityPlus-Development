...
{
    [CalloutInfo("LoiterLS5", CalloutProbability.High)]
    
    public class LoiterLS5 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS5");
            
            calloutPosition = new Vector3(-38.89046f, -217.0407f, 45.79963f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 109.8799f);
            suspect2 = new Ped(new Vector3(-41.46021f, -217.1435f, 45.80023f), 257.6963f);
            suspect3 = new Ped(new Vector3(-40.45686f, -220.1886f, 45.79936f), 327.2811f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS5 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS5 callout has been cleaned up");
        }
    }
}