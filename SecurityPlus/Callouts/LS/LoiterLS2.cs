...
{
    [CalloutInfo("LoiterLS2", CalloutProbability.High)]
    
    public class LoiterLS2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS2");
            
            calloutPosition = new Vector3(206.0507f, -29.4478f, 69.68876f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 262.0496f);
            suspect2 = new Ped(new Vector3(208.1857f, -27.65198f, 69.70217f), 133.9015f);
            suspect3 = new Ped(new Vector3(208.2364f, -30.01022f, 69.66889f), 52.21835f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS2 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS2 callout has been cleaned up");
        }
    }
}