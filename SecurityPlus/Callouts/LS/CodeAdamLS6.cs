...
{
    [CalloutInfo("CodeAdamLS6", CalloutProbability.High)]
    
    public class CodeAdamLS6 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS6");
            
            calloutPosition = new Vector3(1177.334f, -294.9744f, 68.71861f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 279.8134f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 279.8134f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS6 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS6 callout has been cleaned up");
        }
    }
}