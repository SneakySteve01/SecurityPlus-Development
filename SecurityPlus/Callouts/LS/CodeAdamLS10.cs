...
{
    [CalloutInfo("CodeAdamLS10", CalloutProbability.High)]
    
    public class CodeAdamLS10 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS10");
            
            calloutPosition = new Vector3(234.539f, -33.51352f, 69.45284f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 162.598f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 162.598f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS10 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS10 callout has been cleaned up");
        }
    }
}