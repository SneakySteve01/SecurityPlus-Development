...
{
    [CalloutInfo("FakeCredentialsHelipad", CalloutProbability.High)]
    
    public class FakeCredentialsHelipad : Callout
    {
        ...
        {
            Log.log("Starting Callout - FakeCredentialsHelipad");
            
            calloutPosition = new Vector3(-707.8867f, -1374.674f, 4.853336f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 139.4093f);
            susCar = new Vehicle(cars[new Random().Next(cars.Length)], calloutPosition, 139.4093f);

            suspect.WarpIntoVehicle(susCar, -1);
            
            gatePed = new Ped("IG_TRAFFICWARDEN", new Vector3(-712.8375f, -1377.373f, 5.150615f), 293.4605f);
                ...
                case 0:
                {
                    ...
                    if (optionTime)
                    {
                        if (Game.IsKeyDown(Keys.I) && !iPressed)
                        {
                            ...
                            cop = new Ped(peds[new Random().Next(peds.Length)], new Vector3(-661.0926f, -1312.782f, 10.17639f), 198.7548f);
                            cop2 = new Ped(peds[new Random().Next(peds.Length)], new Vector3(-661.0926f, -1312.782f, 10.17639f), 198.7548f);
                            copCar = new Vehicle(cars[new Random().Next(cars.Length)], new Vector3(-661.0926f, -1312.782f, 10.17639f), 198.7548f);
                            ...
                            cop.Tasks.DriveToPosition(copCar, new Vector3(-693.339f, -1362.691f, 6.390269f), 10f, VehicleDrivingFlags.Emergency, 1f).WaitForCompletion();
                            ...
                            if (suspect.IsCuffed)
                            {
                                ...
                                cop.Tasks.DriveToPosition(copCar, new Vector3(-652.0353f, -1437.781f, 10.29849f), 15f, VehicleDrivingFlags.Emergency, 2f).WaitForCompletion(15000);
                                Game.DisplayNotification("Security Dispatcher: Attention " + Main.UID + ", call is code 4.");
                                End();
                                if (cop.DistanceTo(new Vector3(-652.0353f, -1437.781f, 10.29849f)) < 5f || cop2.DistanceTo(new Vector3(-652.0353f, -1437.781f, 10.29849f)) < 5f || suspect.DistanceTo(new Vector3(-652.0353f, -1437.781f, 10.29849f)) < 5f || copCar.DistanceTo(new Vector3(-652.0353f, -1437.781f, 10.29849f)) < 5f)
                                {
                                    Game.DisplayNotification("Security Dispatcher: Attention " + Main.UID + ", call is code 4.");
                                    End();
                                }
        ...
        public override void End()
        {
            ...
            Log.log("Security+ FakeCredentialsHelipad callout has been cleaned up");
            Game.LogTrivial("Security+ FakeCredentialsHelipad callout has been cleaned up");
        }
    }
}