...
{
    [CalloutInfo("CodeAdamLS5", CalloutProbability.High)]
    
    public class CodeAdamLS5 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS5");
            
            calloutPosition = new Vector3(647.0601f, 280.5325f, 102.9012f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 147.5342f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 147.5342f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS5 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS5 callout has been cleaned up");
        }
    }
}