...
{
    [CalloutInfo("CasingLS5", CalloutProbability.High)]
    
    public class CasingLS5 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS5");
            
            calloutPosition = new Vector3(-42.07699f, -228.7091f, 45.79961f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 19.00202f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(-41.13823f, -226.2323f, 45.7996f), 11.45351f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS5 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS5 callout has been cleaned up");
        }
    }
}