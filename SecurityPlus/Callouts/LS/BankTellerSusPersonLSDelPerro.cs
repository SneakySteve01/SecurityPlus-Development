...
{
    [CalloutInfo("BankTellerSusPersonLSDelPerro", CalloutProbability.High)]
    
    public class BankTellerSusPersonLSDelPerro : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonLSDelPerro");
            
            calloutPosition = new Vector3(-1218.16f, -319.789f, 37.67741f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 204.0925f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonLSDelPerro callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonLSDelPerro callout has been cleaned up");
        }
    }
}