...
{
    [CalloutInfo("CasingLS3", CalloutProbability.High)]
    
    public class CasingLS3 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS3");
            
            calloutPosition = new Vector3(-811.7526f, -1078.102f, 11.13755f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 99.23742f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(-812.5732f, -1076.813f, 11.13755f), 113.2439f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS3 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS3 callout has been cleaned up");
        }
    }
}