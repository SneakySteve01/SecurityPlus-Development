...
{
    [CalloutInfo("CodeAdamLS9", CalloutProbability.High)]
    
    public class CodeAdamLS9 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLS9");
            
            calloutPosition = new Vector3(-336.1091f, -1460.161f, 30.28354f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 271.6978f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 271.6978f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLS9 callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLS9 callout has been cleaned up");
        }
    }
}