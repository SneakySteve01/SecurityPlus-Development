...
{
    [CalloutInfo("BankTellerSusPersonLSBurton", CalloutProbability.High)]
    
    public class BankTellerSusPersonLSBurton : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonLSBurton");
            
            calloutPosition = new Vector3(-352.4771f, -41.57203f, 49.03679f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 203.1299f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonLSBurton callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonLSBurton callout has been cleaned up");
        }
    }
}