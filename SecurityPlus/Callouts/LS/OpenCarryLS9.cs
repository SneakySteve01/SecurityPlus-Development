...
{
    [CalloutInfo("OpenCarryLS9", CalloutProbability.High)]
    
    public class OpenCarryLS9 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS9");
            
            calloutPosition = new Vector3(226.7758f, -1791.612f, 28.70485f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 153.4413f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS9 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS9 callout has been cleaned up");
        }
    }
}