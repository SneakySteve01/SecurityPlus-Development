...
{
    [CalloutInfo("OpenCarryLS8", CalloutProbability.High)]
    
    public class OpenCarryLS8 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS8");
            
            calloutPosition = new Vector3(1207.935f, -1389.379f, 35.3769f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 189.5124f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS8 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS8 callout has been cleaned up");
        }
    }
}