...
{
    [CalloutInfo("OpenCarryLS", CalloutProbability.High)]
    
    public class OpenCarryLS : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryLS");
            
            calloutPosition = new Vector3(-576.873f, -1016.452f, 22.32506f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 183.2647f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryLS callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryLS callout has been cleaned up");
        }
    }
}