...
{
    [CalloutInfo("CasingLS", CalloutProbability.High)]
    
    public class CasingLS : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLS");
            
            calloutPosition = new Vector3(-581.1194f, -1023.695f, 22.32968f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 336.9223f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(-582.0885f, -1021.871f, 22.32968f), 313.6569f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLS callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLS callout has been cleaned up");
        }
    }
}