...
{
    [CalloutInfo("LoiterLS6", CalloutProbability.High)]
    
    public class LoiterLS6 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS6");
            
            calloutPosition = new Vector3(644.598f, 264.3044f, 103.2956f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 93.68082f);
            suspect2 = new Ped(new Vector3(641.7525f, 265.0325f, 103.1576f), 228.7602f);
            suspect3 = new Ped(new Vector3(642.8013f, 262.1652f, 103.2955f), 337.229f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS6 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS6 callout has been cleaned up");
        }
    }
}