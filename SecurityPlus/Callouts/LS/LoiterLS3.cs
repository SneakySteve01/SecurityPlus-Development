...
{
    [CalloutInfo("LoiterLS3", CalloutProbability.High)]
    
    public class LoiterLS3 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLS3");
            
            calloutPosition = new Vector3(-814.0079f, -1077.382f, 11.13259f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 145.8496f);
            suspect2 = new Ped(new Vector3(-814.313f, -1079.722f, 11.13253f), 356.2062f);
            suspect3 = new Ped(new Vector3(-815.8292f, -1079.007f, 11.13254f), 288.6566f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLS3 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLS3 callout has been cleaned up");
        }
    }
}