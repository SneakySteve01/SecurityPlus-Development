...
{
    [CalloutInfo("BankTellerSusPersonLSPillbox", CalloutProbability.High)]
    
    public class BankTellerSusPersonLSPillbox : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonLSPillbox");
            
            calloutPosition = new Vector3(155.3521f, -1032.744f, 29.33732f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 137.09f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonLSPillbox callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonLSPillbox callout has been cleaned up");
        }
    }
}