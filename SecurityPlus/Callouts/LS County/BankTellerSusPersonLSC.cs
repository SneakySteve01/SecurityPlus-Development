...
{
    [CalloutInfo("BankTellerSusPersonLSC", CalloutProbability.High)]
    
    public class BankTellerSusPersonLSC : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonLSC");
            
            calloutPosition = new Vector3(-2969.201f, 485.3111f, 15.4687f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 240.1794f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonLSC callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonLSC callout has been cleaned up");
        }
    }
}