...
{
    [CalloutInfo("CodeAdamLSC", CalloutProbability.High)]
    
    public class CodeAdamLSC : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamLSC");
            
            calloutPosition = new Vector3(2582.62f, 428.2555f, 108.194f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 178.9619f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 178.9619f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamLSC callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamLSC callout has been cleaned up");
        }
    }
}