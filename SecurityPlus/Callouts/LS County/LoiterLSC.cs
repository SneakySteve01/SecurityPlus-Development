...
{
    [CalloutInfo("LoiterLSC", CalloutProbability.High)]
    
    public class LoiterLSC : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterLSC");
            
            calloutPosition = new Vector3(-2964.475f, 444.1074f, 15.26695f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 139.7563f);
            suspect2 = new Ped(new Vector3(-2967.282f, 443.8631f, 15.23822f), 261.8277f);
            suspect3 = new Ped(new Vector3(-2964.158f, 441.1915f, 15.24195f), 16.51585f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterLSC callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterLSC callout has been cleaned up");
        }
    }
}