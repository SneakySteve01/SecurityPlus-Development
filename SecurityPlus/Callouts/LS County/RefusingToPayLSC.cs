...
{
    [CalloutInfo("RefusingToPayLSC", CalloutProbability.High)]
    
    public class RefusingToPayLSC : Callout
    {
        ...
        {
            Log.log("Starting Callout - RefusingToPayLSC");
            
            calloutPosition = new Vector3(2581.329f, 464.9786f, 108.628f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            owner = new Ped("s_m_y_waiter_01", calloutPosition, 182.2544f);
            
            suspect = new Ped(new Vector3(2581.533f, 460.6538f, 108.455f), 2.887056f);

            suspect.Inventory.GiveNewWeapon(WeaponHash.CombatPistol, -1, false);

            susCar = new Vehicle("BALLER", new Vector3(2587.884f, 446.7686f, 108.4341f), 85.3831f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ RefusingToPayLSC callout has been cleaned up");
            Game.LogTrivial("Security+ RefusingToPayLSC callout has been cleaned up");
        }
    }
}