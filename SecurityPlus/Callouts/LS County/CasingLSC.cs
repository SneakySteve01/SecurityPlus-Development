...
{
    [CalloutInfo("CasingLSC", CalloutProbability.High)]
    
    public class CasingLSC : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingLSC");
            
            calloutPosition = new Vector3( 2553.632f, 390.7813f, 108.6229f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 183.041f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(2554.583f, 389.7664f, 108.6229f), 256.6254f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingLSC callout has been cleaned up");
            Game.LogTrivial("Security+ CasingLSC callout has been cleaned up");
        }
    }
}