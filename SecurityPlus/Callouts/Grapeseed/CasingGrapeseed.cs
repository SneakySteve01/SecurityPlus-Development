...
{
    [CalloutInfo("CasingGrapeseed", CalloutProbability.High)]
    
    public class CasingGrapeseed : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingGrapeseed");
            
            calloutPosition = new Vector3(1681.752f, 4814.947f, 42.04432f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 310.3589f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(1682.911f, 4814.917f, 42.0864f), 318.5214f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingGrapeseed callout has been cleaned up");
            Game.LogTrivial("Security+ CasingGrapeseed callout has been cleaned up");
        }
    }
}