...
namespace SecurityPlus.Callouts.Grapeseed
{
    [CalloutInfo("LoiterGrapeseed", CalloutProbability.High)]
    
    public class LoiterGrapeseed : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterGrapeseed");
            
            calloutPosition = new Vector3(1702.274f, 4934.888f, 42.07817f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 52.77061f);
            suspect2 = new Ped(new Vector3(1700.762f, 4937.678f, 42.07817f), 208.9366f);
            suspect3 = new Ped(new Vector3(1699.427f, 4934.599f, 42.07814f), 296.899f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterGrapeseed callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterGrapeseed callout has been cleaned up");
        }
    }
}