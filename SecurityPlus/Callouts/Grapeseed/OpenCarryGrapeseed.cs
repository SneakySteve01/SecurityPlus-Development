...
{
    [CalloutInfo("OpenCarryGrapeseed", CalloutProbability.High)]
    
    public class OpenCarryGrapeseed : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryGrapeseed");
            
            calloutPosition = new Vector3(1707.543f, 4930.226f, 42.06368f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 76.9599f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryGrapeseed callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryGrapeseed callout has been cleaned up");
        }
    }
}