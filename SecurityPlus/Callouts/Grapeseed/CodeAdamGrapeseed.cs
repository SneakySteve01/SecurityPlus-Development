...
{
    [CalloutInfo("CodeAdamGrapeseed", CalloutProbability.High)]
    
    public class CodeAdamGrapeseed : Callout
    {
        ...
        {
            Log.log("Starting Callout - CodeAdamGrapeseed");
            
            calloutPosition = new Vector3(1695.013f, 4916.596f, 41.81653f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 57.10473f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 57.10473f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamGrapeseed callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamGrapeseed callout has been cleaned up");
        }
    }
}