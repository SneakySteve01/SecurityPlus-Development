...
{
    [CalloutInfo("CasingGrapeseed2", CalloutProbability.High)]
    
    public class CasingGrapeseed2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingGrapeseed2");
            
            calloutPosition = new Vector3(1703.841f, 4932.921f, 42.06368f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 148.4781f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(1705.021f, 4931.788f, 42.06368f), 250.1041f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingGrapeseed2 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingGrapeseed2 callout has been cleaned up");
        }
    }
}