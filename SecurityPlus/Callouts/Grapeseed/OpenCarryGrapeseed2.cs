...
{
    [CalloutInfo("OpenCarryGrapeseed2", CalloutProbability.High)]
    
    public class OpenCarryGrapeseed2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryGrapeseed2");
            
            calloutPosition = new Vector3(2457.564f, 4062.051f, 38.06471f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 257.0737f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryGrapeseed2 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryGrapeseed2 callout has been cleaned up");
        }
    }
}