...
{
    [CalloutInfo("CasingHarmony2", CalloutProbability.High)]
    
    public class CasingHarmony2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingHarmony2");
            
            calloutPosition = new Vector3(582.5007f, 2741.621f, 42.09908f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 286.3761f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(583.3173f, 2743.329f, 42.0937f), 262.9203f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingHarmony2 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingHarmony2 callout has been cleaned up");
        }
    }
}