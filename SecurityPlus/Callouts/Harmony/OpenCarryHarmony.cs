...
{
    [CalloutInfo("OpenCarryHarmony", CalloutProbability.High)]
    
    public class OpenCarryHarmony : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryHarmony");
            
            calloutPosition = new Vector3(341.3853f, 2615.773f, 44.66444f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 31.7271f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryHarmony callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryHarmony callout has been cleaned up");
        }
    }
}