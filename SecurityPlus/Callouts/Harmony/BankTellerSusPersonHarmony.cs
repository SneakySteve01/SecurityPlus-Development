...
{
    [CalloutInfo("BankTellerSusPersonHarmony", CalloutProbability.High)]
    
    public class BankTellerSusPersonHarmony : Callout
    {
        ...
        {
            Log.log("Starting Callout - BankTellerSusPersonHarmony");
            
            calloutPosition = new Vector3(1177.284f, 2699.702f, 38.17124f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 17.51538f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ BankTellerSusPersonHarmony callout has been cleaned up");
            Game.LogTrivial("Security+ BankTellerSusPersonHarmony callout has been cleaned up");
        }
    }
}