...
{
    [CalloutInfo("OpenCarryHarmony2", CalloutProbability.High)]
    
    public class OpenCarryHarmony2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryHarmony2");
            
            calloutPosition = new Vector3(587.307f, 2743.648f, 42.07095f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 189.2077f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryHarmony2 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryHarmony2 callout has been cleaned up");
        }
    }
}