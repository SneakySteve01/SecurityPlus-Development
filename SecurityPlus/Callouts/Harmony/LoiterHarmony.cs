...
{
    [CalloutInfo("LoiterHarmony", CalloutProbability.High)]
    
    public class LoiterHarmony : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterHarmony");
            
            calloutPosition = new Vector3(1203.853f, 2703.198f, 38.00216f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 217.8206f);
            suspect2 = new Ped(new Vector3(1204.102f, 2700.987f, 37.98668f), 334.4448f);
            suspect3 = new Ped(new Vector3(1206.476f, 2702.424f, 37.97915f), 78.43604f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterHarmony callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterHarmony callout has been cleaned up");
        }
    }
}