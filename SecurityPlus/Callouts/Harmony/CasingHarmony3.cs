...
{
    [CalloutInfo("CasingHarmony3", CalloutProbability.High)]
    
    public class CasingHarmony3 : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingHarmony3");
            
            calloutPosition = new Vector3(540.1122f, 2670.827f, 42.15654f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 268.7617f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(541.1844f, 2669.373f, 42.15654f), 213.9933f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingHarmony3 callout has been cleaned up");
            Game.LogTrivial("Security+ CasingHarmony3 callout has been cleaned up");
        }
    }
}