...
{
    [CalloutInfo("OpenCarryHarmony3", CalloutProbability.High)]
    
    public class OpenCarryHarmony3 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarryHarmony3");
            
            calloutPosition = new Vector3(1168.786f, 2706.779f, 38.1577f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 96.63175f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarryHarmony3 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarryHarmony3 callout has been cleaned up");
        }
    }
}