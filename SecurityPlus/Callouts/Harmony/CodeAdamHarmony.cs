...
{
    [CalloutInfo("CodeAdamHarmony", CalloutProbability.High)]
    
    public class CodeAdamHarmony : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            calloutPosition = new Vector3(612.39f, 2723.849f, 41.60577f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 7.77918f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 7.77918f);
                    suspect = new Ped(calloutPosition, 97.07672f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamHarmony callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamHarmony callout has been cleaned up");
        }
    }
}