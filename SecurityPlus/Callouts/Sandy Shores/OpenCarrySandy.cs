...
{
    [CalloutInfo("OpenCarrySandy", CalloutProbability.High)]
    
    public class OpenCarrySandy : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarrySandy");
            
            calloutPosition = new Vector3(1967.163f, 3743.695f, 32.34374f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 117.0517f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarrySandy callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarrySandy callout has been cleaned up");
        }
    }
}