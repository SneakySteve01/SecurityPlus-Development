...
{
    [CalloutInfo("CodeAdamSandy", CalloutProbability.High)]
    
    public class CodeAdamSandy : Callout
    {
        ...
        private int option, counter;

        private bool convoStarted;
        
        public override bool OnBeforeCalloutDisplayed()
        {
            Log.log("Starting Callout - CodeAdamSandy");
            
            calloutPosition = new Vector3(1979.851f, 3782.857f, 31.91893f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            switch (option)
            {
                case 0:
                {
                    ...
                    susCar = new Vehicle("SPEEDO", calloutPosition, 211.5709f);
                    suspect = new Ped(new Vector3(2013.928f, 3771.692f, 32.18079f), 97.07672f);
                    suspect.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);

                    suspect.WarpIntoVehicle(susCar, -1);
            
                    victim = new Ped("cs_tracydisanto", new Vector3(2011.721f, 3772.065f, 32.18079f), 101.1328f);
                ...
                case 1:
                {
                    ...
                    susCar = new Vehicle("BALLER", calloutPosition, 211.5709f);
                    suspect = new Ped(new Vector3(2013.928f, 3771.692f, 32.18079f), 97.07672f);
                    suspect.WarpIntoVehicle(susCar, -1);
                    
                    victim = new Ped(new Vector3(2011.721f, 3772.065f, 32.18079f), 101.1328f);
                    victim.WarpIntoVehicle(susCar, 1);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CodeAdamSandy callout has been cleaned up");
            Game.LogTrivial("Security+ CodeAdamSandy callout has been cleaned up");
        }
    }
}