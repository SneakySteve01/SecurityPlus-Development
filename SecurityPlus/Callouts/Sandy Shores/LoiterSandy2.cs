...
{
    [CalloutInfo("LoiterSandy2", CalloutProbability.High)]
    
    public class LoiterSandy2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - LoiterSandy2");
            
            calloutPosition = new Vector3(1992.832f, 3758.94f, 32.18071f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 33.6517f);
            suspect2 = new Ped(new Vector3(1989.921f, 3759.163f, 32.17812f), 273.5156f);
            suspect3 = new Ped(new Vector3(1993.186f, 3761.738f, 32.1807f), 154.3211f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ LoiterSandy2 callout has been cleaned up");
            Game.LogTrivial("Security+ LoiterSandy2 callout has been cleaned up");
        }
    }
}