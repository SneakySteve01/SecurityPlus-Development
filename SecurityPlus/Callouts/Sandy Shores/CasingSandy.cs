...
{
    [CalloutInfo("CasingSandy", CalloutProbability.High)]
    
    public class CasingSandy : Callout
    {
        ...
        {
            Log.log("Starting Callout - CasingSandy");
            
            calloutPosition = new Vector3(1968.072f, 3744.067f, 32.34375f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect1 = new Ped(calloutPosition, 94.63285f);
            suspect1.Inventory.GiveNewWeapon(WeaponHash.Knife, -1, true);
            
            suspect2 = new Ped(new Vector3(1966.361f, 3745.878f, 32.34375f), 15.3447f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ CasingSandy callout has been cleaned up");
            Game.LogTrivial("Security+ CasingSandy callout has been cleaned up");
        }
    }
}