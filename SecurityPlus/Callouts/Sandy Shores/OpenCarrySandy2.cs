...
{
    [CalloutInfo("OpenCarrySandy2", CalloutProbability.High)]
    
    public class OpenCarrySandy2 : Callout
    {
        ...
        {
            Log.log("Starting Callout - OpenCarrySandy2");
            
            calloutPosition = new Vector3(1392.847f, 3598.818f, 35.02206f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            suspect = new Ped(calloutPosition, 193.8317f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ OpenCarrySandy2 callout has been cleaned up");
            Game.LogTrivial("Security+ OpenCarrySandy2 callout has been cleaned up");
        }
    }
}