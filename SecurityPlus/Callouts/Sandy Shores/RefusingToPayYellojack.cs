...
{
    [CalloutInfo("RefusingToPayYellowjack", CalloutProbability.High)]
    
    public class RefusingToPayYellowjack : Callout
    {
        ...
        {
            Log.log("Starting Callout - RefusingToPayYellowjack");
            
            calloutPosition = new Vector3(1991.587f, 3054.299f, 47.21488f);
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            owner = new Ped("s_m_y_waiter_01", calloutPosition, 243.6664f);
            
            suspect = new Ped(new Vector3(1994.327f, 3053.103f, 47.21451f), 58.01924f);

            suspect.Inventory.GiveNewWeapon(WeaponHash.CombatPistol, -1, false);

            susCar = new Vehicle("BALLER", new Vector3(1992.971f, 3069.611f, 47.01875f), 55.78096f);
        ...
        public override void End()
        {
            ...
            Log.log("Security+ RefusingToPayYellowjack callout has been cleaned up");
            Game.LogTrivial("Security+ RefusingToPayYellowjack callout has been cleaned up");
        }
    }
}